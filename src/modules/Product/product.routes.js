...
router.get('/sort', expressAsyncHandler(productController.sortAllProducts))
router.get('/search', expressAsyncHandler(productController.searchAllProducts))
router.get('/filter', expressAsyncHandler(productController.filterAllProducts))
